...
$obj_merged = (object) array_merge((array) $employee_info, (array) $salaryvaluebyid, (array) $salarypaybyid, (array) $salaryvalue, (array) $loanvaluebyid);
    ...
    public function mail($kirim){
       ...
       <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Hallo ,'.$kirim['emp_id'].'</p>
       ...
       <thead>
               ...
               <tr>
                   ...
                   <td>'.$kirim["paid_date"].'</td>
                   <th>Tipe Pembayaran</th>
                   <td>'.$kirim["paid_type"].'</td>
                   <th>Status</th>
                   <td>'.$kirim["status"].'</td>
               </tr>
               </thead> 
           ...
           <table class="table table-bordered">
               ...
               <tbody>
                   <tr>
                       <th>1</th>
                       <td>Gaji Pokok</td>
                       <td>Rp. '.number_format($kirim["basic"]).'</td>
                   </tr>
                   <tr>
                       <th>2</th>
                       <td>Tunjangan</td>
                       <td>Rp. '.number_format($kirim["addition"]).'</td>
                   </tr>
                   <tr>
                       <th>3</th>
                       <td>Pinjaman</td>
                       <td>Rp. '.number_format($kirim["loan"]).'</td>
                   </tr>
                   <tr>
                       <th>4</th>
                       <td>Potongan</td>
                       <td>Rp. '.number_format($kirim["diduction"]).'</td>
                   </tr>
                   <tr>
                       <th colspan="2">TOTAL DITERIMA</th>
                       <th>Rp. '.number_format($kirim["total_pay"]).'
                       </th>
                   </tr>
               </tbody>
           </table>
